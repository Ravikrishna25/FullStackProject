...
public class Delete extends Base {
	...
	private void delete(String tableName, String whereCondtion) {
		try {
			String queryD = "delete from employeeDependents"+ " where eId = " + whereCondtion;
			String queryC = "delete from employeeContactDetails"  + " where eId = " + whereCondtion;
			String queryA = "delete from employeeAddressDetails" + " where eId = " + whereCondtion;
			String queryE = "delete from employee"  + " where eId = " + whereCondtion;
			connect.prepareStatement(queryD).executeUpdate();
			connect.prepareStatement(queryC).executeUpdate();
			connect.prepareStatement(queryA).executeUpdate();
			connect.prepareStatement(queryE).executeUpdate();
