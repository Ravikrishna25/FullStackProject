...
const items = [
  ...
  getItem('Case Assignment', 'sub3', <MailOutlined />, null, 'item', '/admin/ele2'),
  getItem('Chat Console', 'sub4', <AppstoreOutlined />, null, 'item', '/admin/ele2'),
...
// >
// <Title level={3} style={{ margin: '16px', color: 'white' }}>Sidebar Title</Title>
